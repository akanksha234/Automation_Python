...
file_to_write = Path('../Files/access_log.csv')

with open(file_to_write, 'w') as log_file:
    log_file_writer = csv.DictWriter(log_file, fieldnames=fields)
    log_file_writer.writeheader()
    for line in access_log:
        log_file_writer.writerow(line)
